...
<body>
    ...
    <div class="main d-block">
        ...
        <?php
        $action = ($_GET['type'] == 'In') ? 'Mobile_insert.php' : 'Mobile_update.php';
        ?>
        <div class="attd-content" id="detected">
            <form id="faceForm" method="POST" action="<?php echo $action; ?>" enctype="multipart/form-data">
                <input type="hidden" name="latitude" id="" value="<?php echo $_GET['latitude']; ?>">
                <input type="hidden" name="longitude" id="" value="<?php echo $_GET['longitude']; ?>">
                <input type="hidden" name="database" id="" value="<?php echo $_GET['db_base']; ?>">
                ...
                <div class="attd-main-div">
                    <div class="attd-div">
                        <div class="col-sm-12 mb-3">
                            ...
                            <h6 class="text-dark"><?php echo $_GET['latitude']; ?></h6>
                        </div>
                        <div class="col-sm-12 mb-3">
                            <h6 class="text-muted">Longitude</h6>
                            <h6 class="text-dark">:</h6>
                            <h6 class="text-dark"><?php echo $_GET['longitude']; ?></h6>
                        </div>
                    </div>
                    <div class="attd-div">
                        <div class="col-sm-12 mb-3">
